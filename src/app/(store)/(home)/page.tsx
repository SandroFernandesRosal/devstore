...
export default async function Home() {
  ...
  return (
    <div className="grid max-h-[860px] lg:grid-cols-9 lg:grid-rows-6 gap-6 px-8 pt-20">
      <Link
      ...
      >
        ...
        <div className="absolute bottom-10 right-0 h-12 mr-2 flex items-center gap-2 max-w-[3005px] rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
