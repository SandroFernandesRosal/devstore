    ...
    <div className="mt-10">
      ...
      <div className="flex flex-wrap w-full  gap-3 justify-center md:justify-start ">
        {products.map((product: Product) => {
          return (
            <div
              className="w-[47%] max-w-[200px] gap-2 pb-2 flex  flex-col pt-2  dark:bg-bgdarksecundary bg-bglightsecundary shadow shadow-gray-500 rounded-md dark:shadow-shadowfooterdark  "
              key={product.id}
            >
