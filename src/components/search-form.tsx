...
export function SearchForm() {
  ...
  return (
    <form
      ...
      className="flex max-w-[320px] items-center md:gap-3 rounded-full dark:bg-bgdarksecundary bg-bglightsecundary  md:px-5  p-1 shadow shadow-gray-500 dark:shadow-shadowfooterdark"
    >
